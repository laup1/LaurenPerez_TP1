...
/**
 * AgenciesFilesFixture
 *
 */
class AgenciesFilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'agencies_files_ibfk_2' => ['type' => 'foreign', 'columns' => ['file_id'], 'references' => ['files', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'agencies_files_ibfk_3' => ['type' => 'foreign', 'columns' => ['agencie_id'], 'references' => ['agencies', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
